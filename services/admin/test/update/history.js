...
describe('Test: daily update route test with history', () => {
  ...
  describe('insert changefile 2020-01-02', () => {
    ...
    it('Should get unpaywall document in base and history', async () => {
      ...
      const baseRes = await searchByDOI(['1', '2', '3', '4', '5'], 'unpaywall-base');
      ...
      const historyRes = await searchByDOI(['1', '2', '3', '4', '5'], 'unpaywall-history');
    ...
    function testResult(result) {
      ...
      expect(indices[1]).have.property('index').equal('unpaywall-history');
