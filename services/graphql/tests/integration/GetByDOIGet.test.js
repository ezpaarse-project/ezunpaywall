...
describe('Graphql: GET GetByDOI resolver', () => {
  ...
  describe(`GET: get unpaywall data for DOI ${doi6}`, () => {
  ...
  describe(`GET: get unpaywall data for DOI ${doi3a} not normalized`, () => {
  ...
  describe(`GET: get unpaywall data for DOI ${doi3b} not normalized`, () => {
  ...
  describe(`GET: get unpaywall data for DOI ${doi1} ${doi2}`, () => {
  ...
  describe(`GET: get unpaywall data for DOI ${doi1} ${doi6}`, () => {
